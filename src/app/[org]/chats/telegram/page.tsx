...
const mockConversations = [
  ...
  },
  {
    id: 2,
    name: "Maria Santos",
    lastMessage: "Preciso de ajuda com a documentação",
    timestamp: "09:15",
    unread: 0,
  ...
  },
  {
    id: 5,
    name: "Carlos Lima",
    lastMessage: "Vou enviar os arquivos em breve",
    timestamp: "Seg",
    unread: 0,
          ...
          <div className="flex h-[calc(100vh-4rem)] bg-gray-50">
            ...
            <div className="w-1/3 bg-white border-r border-gray-200 flex flex-col">
              ...
              <div className="p-4 border-b border-gray-200">
                <h1 className="text-xl font-semibold text-gray-800 mb-4">Telegram</h1>
