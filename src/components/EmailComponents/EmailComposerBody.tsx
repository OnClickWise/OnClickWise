  ...
  return (
    ...
    >
      <div className="w-full mb-16 bg-white p-5 flex flex-col gap-4 shadow-lg">
        ...
        <div className="flex items-center justify-between border-t py-2 pb-0 mt-2">
          <div className="flex items-center gap-2 text-gray-600">
            ...
            <Button
              ...
              className={
                isItalicActive ? "bg-gray-200 rounded-xl" : "rounded-xl"
              }
            ...
            <select
              ...
              className="border rounded-xl px-2 text-xs bg-white cursor-pointer"
          ...
          {/* Botão de Envio */}
          <Button type="submit" className="rounded-full py-6 text-md w-13 h-13">
            <ArrowRight size={16} />
          </Button>
        </div>
      </div>
