    ...
    <div className="flex-1 bg-gray-100 p-6 overflow-y-auto">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6 p-4 bg-white rounded-lg shadow">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600">Visualização como aparecerá para os visitantes</p>
            </div>
        ...
        <div className="mt-6 p-4 bg-white rounded-lg shadow">
          <h4 className="font-semibold text-gray-900 mb-3">Informações da Landing Page</h4>
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <span className="ml-2 font-medium">{config.primaryColor}</span>
            </div>
            <div>
              <span className="text-gray-600">Cor Secundária:</span>
              <span className="ml-2 font-medium">{config.secondaryColor}</span>
            </div>
          </div>
        </div>
      </div>
